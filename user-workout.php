...
<head>
  ...
  <link rel="stylesheet" href="user-workout.css" />
  <style>
    ::selection {
...
<body>
  ...
  <div class="container">
    <p id="workout-title">WORKOUTS</p>
    <p id="desc">REVAMP YOUR PHYSIQUE</p>
  </div>
  ...
  <div class="container">
    <div class="cards grid">
      ...
      // Now you can proceed with fetching data from the database and generating HTML dynamically
      // Assuming you have already connected to your MySQL database
      
      // Fetch data from the database
      $query = "SELECT * FROM workout"; // Replace your_table_name with the actual table name
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          echo '<div class="card">
                ...
                <div class="card-content">
                  ...
                  <a href="user-workout-info.php?title=' . urlencode($title) . '" class="read-more-btn">Lets Workout</a>
                  </div>
              </div>';
        }
      } else {
