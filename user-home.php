...
.icons a:hover i {
  ...
  .btn-up {
    margin-top: -150px; /* Adjust the value to bring the button upwards */
  ...
  <hr style="color: rgb(255, 255, 255)" />
    ...
    <section>
        ...
        <p class="p1">WE ARE NOT JUST A GYM,<br>
          ...
          </BR>ELEVATE YOUR FITNESS GAME</p>
           <div class="text-center">
           <button type="button" class="btn btn-outline-warning btn-up"><a href="user-aboutus.php">ABOUT US</a></button>
          </div>
        ...
        <div class="card-container">
          <div class="card">
            <img src="certify-removebg-preview.png" alt="Certified Trainers" width="40px" height="40px">
              ...
              <p class="para">All our trainers are certified and well mannered so you get proper training and you feel most comfortable!</p>
          </div>
          <div class="card">
            <img src="equipmengt-removebg-preview.png" alt="Certified Trainers" width="40px" height="40px">
              <h2 class="head">Best Equipment</h2>
              <p class="para">We have equipped the gym with latest and best in class machines, so your workout is most effective.
          ...
          <div class="card">
            <img src="personal-removebg-preview.png" alt="Certified Trainers" width="40px" height="40px">
              ...
              <p class="para">Our personal trainers are ready to take up the challenge with you, and help you achieve your health goals.</p>
          </div>
      </div>
    ...
    <div style ="position: fixed; bottom: 20px;right:20px;">
      <a class="btn btn-dark" href="user-plan.php">Today's Plan??</a>
    </div>
