...
<head>
  ...
  <link rel="stylesheet" href="user-program-amenities.css" />
  <!-- Bootstrap CSS -->
    ...
    <div class="class__grid">
      ...
      if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
          echo '<div class="class__card">';
          echo '<img src="pbg.png" alt="bg" class="class__bg" />';
          echo '<img src="' . $row["image"] . '" alt="class" style="width: 268px; height: 231px; object-fit: cover"/>';
          echo '<div class="class__content">';
