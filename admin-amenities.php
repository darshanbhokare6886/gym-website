...
<body class="font-sans">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (isset($_POST['add'])) { // Add button clicked
            ...
            $sql = "INSERT INTO `cpdb`.`amenities` (`title`, `description`, `image`) VALUES ('$title', '$description', '$imagePath');";
            ...
            if (empty($description)) {
                $sql_fetch_description = "SELECT description FROM amenities WHERE title='$title'";
            ...
            if (empty($imagePath)) {
                $sql_fetch_image = "SELECT image FROM amenities WHERE title='$title'";
            ...
            $sql = "UPDATE amenities SET description='$description', image='$imagePath' WHERE title='$title'";
            ...
            $title = $_POST['title'];
            $sql = "DELETE FROM amenities WHERE title='$title'";
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <div id="amenitiesForm" class="form-container">
                    <h3 class="text-center mb-4">Amenities Form</h3>
                    <form action="admin-amenities.php" method="POST" enctype="multipart/form-data">
