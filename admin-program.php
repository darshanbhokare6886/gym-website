...
<body class="font-sans">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (isset($_POST['add'])) { // Add button clicked
            ...
            $sql = "INSERT INTO `cpdb`.`programs` (`title`, `description`, `image`) VALUES ('$title', '$description', '$imagePath');";
            ...
            if (empty($description)) {
                $sql_fetch_description = "SELECT description FROM programs WHERE title='$title'";
            ...
            if (empty($imagePath)) {
                $sql_fetch_image = "SELECT image FROM programs WHERE title='$title'";
            ...
            $sql = "UPDATE programs SET description='$description', image='$imagePath' WHERE title='$title'";
            ...
            $title = $_POST['title'];
            $sql = "DELETE FROM programs WHERE title='$title'";
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <div id="amenitiesForm" class="form-container">
                    ...
                    <form action="admin-program.php" method="POST" enctype="multipart/form-data">
