...
<body class="font-sans">
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['add'])) { // Add button clicked
      ...
      $videolink = isset($_POST['videolink']) ? $_POST['videolink'] : ''; // Check if videolink is set
      $information = isset($_POST['information']) ? $_POST['information'] : ''; // Check if information is set
  
      // SQL query to insert data into the 'workout' table
      $sql = "INSERT INTO `cpdb`.`workout` (`title`, `description`, `image`, `videolink`, `information`) VALUES ('$title', '$description', '$imagePath', '$videolink', '$information');";
      ...
      if (empty($description)) {
        $sql_fetch_description = "SELECT description FROM workout WHERE title='$title'";
      ...
      if (empty($imagePath)) {
        $sql_fetch_image = "SELECT image FROM workout WHERE title='$title'";
      ...
      $sql = "UPDATE workout SET description='$description', image='$imagePath' WHERE title='$title'";
  ...
  <div class="container facility-container mt-5">
    <div class="row justify-content-center">
      <div class="col-md-6">
        <div id="workout-form" class="form-container">
          <h3 class="text-center mb-4">Workout Form</h3>
          <form action="admin-workout.php" method="POST" enctype="multipart/form-data">
            <div class="form-group">
              <label for="title">Title:</label>
              <input type="text" class="form-control" id="title" name="title" placeholder="Enter workout title" />
            </div>
            <div class="form-group">
